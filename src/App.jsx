  ...
  return (
    <div className="main-content fade-in">
      ...
      <div className="dashboard-grid" style={{ padding: '0', marginBottom: 'var(--spacing-xl)' }}>
        <KPIWidget label="Total VSC Contracts" value={contractCount.toLocaleString()} trend="up" percentage="2.5%" isRealtime={true} />
        <KPIWidget label="Pending Approvals" value={pendingApprovals.toLocaleString()} trend="down" percentage="-0.8%" />
        <KPIWidget label="In Progress" value={inProgressContracts.toLocaleString()} />
        <KPIWidget label="Approved Contracts" value={approvedContracts.toLocaleString()} trend="up" percentage="5.1%" />
      </div>
